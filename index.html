...
<body>
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">I am Abdul Qavi</h1>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="assets/img/profile222.jpeg" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span>Abdul Qavi Memon</span></p>
                        <p><span class="title-s">Profile: </span> <span>full stack developer</span></p>
                        <p><span class="title-s">Email: </span> <span>asdtech575@gmail.com</span></p>
                        <p><span class="title-s">Phone: </span> <span>+923052370208</span></p>
                      </div>
                    </div>
                  </div>
                  <div class="skill-mf">
                ...
                <div class="col-md-6">
                  <div class="about-me pt-4 pt-md-0">
                    ...
                    <p class="lead">My name is Abdul Qavi and I am a Full Stack Web Developer with 2 years of experience.
                       
                    </p>
                    <p class="lead">
                      I specialize in developing web applications using various technologies such as HTML, CSS, JavaScript, PHP, and MySQL.
                    </p>
                    <p class="lead">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">
                Making your vision a reality with professional web development services
              </p>
            ...
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">
                  I can design beautiful and responsive websites that are optimized for performance and user experience.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">
                  I can develop web applications using various technologies such as HTML, CSS, JavaScript, PHP, and MySQL.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                ...
                <p class="s-description text-center">
                  I can design responsive website for comonly used devices like desktop,mobile,tab
                </p>
              </div>
            </div>
          </div>
  ...
  <form method="POST" action="php-email-form/PHPMailer-FE_v4.11/_lib/phpmailer-fe.php" enctype="multipart/form-data">
    ...
    &nbsp;
     <input type="submit" value="Submit" class="btn-secondary"name="submit"><input type="reset" class="btn-secondary" value="Reset" name="reset"></td>
  ...
  <tr>
    <td colspan="3"><div style="height:5px;"></div></td>
                   ...
                   <!--   <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                    ...
                    <div class="more-info">
                      <p class="lead">
                       Feel free to contact me for any questions or inquiries. I'll get back to you as soon as possible. </p>
                      <ul class="list-ico">
                     
						<li><i class="fa fa-envelope"></i> asdtech575@gmail.com.com</li>
						<li><i class="fa fa-phone"></i> +92 3052370208</li>
						<li><i class="fa fa-map-marker"></i> Ghotki, 65110,pakistan</li> </ul>
                    </div>
                    <div class="socials">
                      <ul>
